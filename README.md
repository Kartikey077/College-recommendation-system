...
Geopy: For geolocation services, providing college location on OpenStreetMap.
Webbrowser: To open the college’s official website and map location.
```
You can do any central/state college just give .csv file to AI can say add this CSV according to your Counselling which you are doing of any state and then run the program and find college accordingly your best chooice.
